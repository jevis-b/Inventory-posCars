          ...
          <div class="box-body">
            ...
            <div class="col-xs-12 col-sm-6">
              <div class="input-group"> 
                ...
                <?php echo '<input type="number" class="form-control input-lg" id="newBuyingPrice" name="newBuyingPrice" step="any" min="0" placeholder="Buying Price (ZMW)" required>'; ?>
              </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6">  
              <div class="input-group"> 
                ...
                <?php echo '<input type="number" class="form-control input-lg" id="newSellingPrice" name="newSellingPrice" step="any" min="0" placeholder="Selling Price (ZMW)" required>'; ?>
              </div> 
              <br>
              <!-- Checkbox Percentage -->
              <div class="col-xs-6"> 
              ...
              <div class="col-xs-6" style="padding:0">
                <div class="input-group"> 
                  <?php echo '<input type="number" class="form-control input-lg newPercentage" min="0" value="40" required>'; ?>
